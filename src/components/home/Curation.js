        ...
        <div className='container'>
            <div className='row'>
                ...
                <div className='col-md-6 curation-video mb-auto mt-auto'>
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/pnkVW6Sllno" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </div>
