              ...
              <section>
                ...
                <div className="main-colom row col-12 mt-5 mb-5">
                  <div className="colom-left col-md-8  mt-2">
                    ...
                    <p>BUCA IMSEF 2023 🔥</p>
                    <p>Turkey, offline competition</p>
                    <br></br>
                    <p>Hai halo peneliti belia,</p>
                    <p>Di bulan November IYSA punya event afiliasi offline di Turki loh 👏🏻</p>
                    <br></br>
                    <p>Tidak hanya kategori sains saja, ada kategori musik-piano juga 🥳</p>
                    <p>Yuk daftarkan tim kalian, dan simpan postingan ini juga 💥</p>
                    <br></br>                                 
                    <a
